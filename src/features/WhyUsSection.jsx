...
export const WhyUsSection = () => {
    return (
        <section className="flex flex-col justify-start items-start gap-10">
            ...
            <div className="overflow-hidden flex flex-col justify-start items-start bg-gradient p-3 mt-10 rounded-2xl pb-[250px] md:pb-0">
                <div className="text-white relative flex md:flex-row pb-4">
                    <div>
                    ...
                    <img
                        ...
                        className="object-cover absolute bottom-0 translate-y-full left-1/2 -translate-x-1/2 md:relative md:translate-y-0 md:-translate-x-0 md:left-0 md:self-end"
                    />
                </div>
            </div>
